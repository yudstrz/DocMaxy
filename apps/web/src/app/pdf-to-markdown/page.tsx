      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl text-xl text-slate-500 mx-auto">
            Ekstrak teks, struktur, dan tabel dari PDF menjadi format Markdown (.md) yang rapi.
          </p>
        </div>
          ...
          <div className="max-w-3xl mx-auto mt-12 bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
            ...
            <div className="flex justify-center">
              <button onClick={handleConvert} disabled={isProcessing}
                ...
                {isProcessing ? 'Mengunggah & Memproses...' : 'Ubah ke Markdown Sekarang'}
              </button>
            </div>
          </div>
        )}
        ...
        {downloadUrl && (
          <div className="mt-8 max-w-3xl mx-auto p-8 bg-green-50 border border-green-200 rounded-3xl flex flex-col items-center">
            ...
            <a href={downloadUrl} download={documents.length > 1 ? 'pdf_to_md.zip' : documents[0].file.name.replace(/\.[^/.]+$/, ".md")}
