      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto mt-12 bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
            ...
            <div className="flex justify-center">
              <button onClick={handleRotate} disabled={isProcessing}
                className="w-full sm:w-auto px-12 py-4 bg-purple-600 hover:bg-purple-700 text-white font-bold text-lg rounded-2xl shadow-lg transition-all disabled:opacity-50">
        ...
        {downloadUrl && (
          <div className="mt-8 max-w-3xl mx-auto p-8 bg-green-50 dark:bg-emerald-950/40 border border-green-200 dark:border-emerald-900 rounded-3xl flex flex-col items-center">
            ...
            <h3 className="text-2xl font-bold text-green-800 dark:text-emerald-200 mb-3">Berhasil Diputar!</h3>
