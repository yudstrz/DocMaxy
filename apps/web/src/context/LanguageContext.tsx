...
const TRANSLATIONS = {
  id: {
    ...
    // Camera Scanner & Export Settings
    pdfSettingsTitle: "Pengaturan Ekspor PDF",
    pageSize: "Ukuran Kertas",
    pdfMarginLabel: "Margin Halaman",
    orientation: "Orientasi",
    quality: "Kualitas & Kompresi",
    marginNone: "Tanpa Margin (0 mm)",
    marginSmall: "Margin Kecil (5 mm)",
    marginNormal: "Margin Normal (10 mm)",
    orientAuto: "Otomatis (Sesuai Gambar)",
    orientPortrait: "Potret (Portrait)",
    orientLandscape: "Lansekap (Landscape)",
    qualityHigh: "Kualitas Tinggi (100%)",
    qualityMedium: "Sedang (80%)",
    qualityCompact: "Terkompresi (Hemat Ukuran)",
  ...
  en: {
    ...
    // Camera Scanner & Export Settings
    pdfSettingsTitle: "PDF Export Settings",
    pageSize: "Paper Size",
    pdfMarginLabel: "Page Margin",
    orientation: "Orientation",
    quality: "Quality & Compression",
    marginNone: "No Margin (0 mm)",
    marginSmall: "Small Margin (5 mm)",
    marginNormal: "Normal Margin (10 mm)",
    orientAuto: "Auto (Fit Image Ratio)",
    orientPortrait: "Portrait",
    orientLandscape: "Landscape",
    qualityHigh: "High Quality (100%)",
